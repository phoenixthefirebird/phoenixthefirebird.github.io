            ...
            <div className="section">
                <div className="row">
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 cyan lighten-4">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 red lighten-4">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 green lighten-4">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 purple lighten-4">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 lime lighten-4">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 blue lighten-4">
                ...
                <div className="row">
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 pink lighten-4">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 deep-purple lighten-4">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 blue accent-1">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 teal accent-1">
                ...
                <div className="row">
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 amber accent-1">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 pink accent-1">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 lime accent-1">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 light-blue accent-1">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 green accent-1">
                ...
                <div className="row">
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 indigo accent-1">
                    ...
                    <div className="thumbnail col l2 m4 s6 container">
                        ...
                        <div class="overlay2 light-green accent-1">
